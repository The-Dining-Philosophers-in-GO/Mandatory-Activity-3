...
func (c *chitChatClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedChitChatServer) Publish(context.Context, *PublishRequest) (*PublishResponse, error) {
